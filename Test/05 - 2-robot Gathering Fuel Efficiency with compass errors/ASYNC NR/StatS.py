...
COMPASS_ERROR = 49*pi/100 # Angular error (radians)
...
while elapsed<10:
	...
	network.append(Robot('r1',0,0))
	ang = uniform(-pi,pi)
	network.append(Robot('r2',cos(ang),sin(ang)))
	...
	while True:
		...
		scheduler('ASYNC',network,'RDV_compass_SSYNC_static',activated)
